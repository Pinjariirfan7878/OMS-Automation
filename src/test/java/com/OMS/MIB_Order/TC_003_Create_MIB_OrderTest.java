	...
	public void create_MIB_order() throws Throwable 
	{
        ...
        for(WebElement stock:available_stock) 
        {
        	...
        	if(ava_stock>=Dispatch_Qty)
        	{
        		...
        		driver.findElement(By.xpath("(//input[@type=\"number\"]/ancestor::div[@class=\"col\"])[9]//input")).sendKeys(Value);
        		break;
        	}
        }
        Thread.sleep(3000);
       ...
       // driver.findElement(By.xpath("//a[text()='Update Tally Info']")).click();
        ...
        Thread.sleep(500);
      //Runtime.getRuntime().exec("C:\\Users\\irfan.pinjar\\Desktop\\invoicdocument.exe");
        driver.findElement(By.xpath("//button[text()='Save']")).click();
        Thread.sleep(500);
        ...
        Thread.sleep(300);
        driver.findElement(By.xpath("//div[@class=\"day today\"]")).click();
